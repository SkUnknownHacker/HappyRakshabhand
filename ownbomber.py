...
G = '\033[1;32m'
S = '\033[1;33m'
logo=(f"""{E}=========GandFhad-Bomber================
{B}[+] TeleGram   : @SK_TECH_GAMER_YT
{G}[+] Youtube    : SkUnknownHackerr 
{P}[+] InstaGram  : @skunknownhacker
{B}========================================""")
print(logo)
text = """ Sumit PAPA 😈 Bolte Haii

"""
#DO FORGET TO GIVE CREDIT BY BRO
colored_text = (
    Color.YELLOW + text + Color.END  # You can change PURPLE to any other color
)

print(colored_text)

no = str(input('𝐏𝐥𝐞𝐚𝐬𝐞 𝐄𝐧𝐭𝐞𝐫 𝐍𝐮𝐦𝐛𝐞𝐫: '))
